...
public final class BookFixUtil {
    ...
    /**
     * 修复book XML文件，进行下面的操作
     * <book version="5.0">替换成<book xmlns="http://docbook.org/ns/docbook" version="5.0" xmlns:xi="http://www.w3.org/2001/XInclude" xml:lang="zh_cn">
     * include替换成xi:include
     * @param bookXmlPath
     */
    ...
    /**
     * 修复章节 XML文件，进行下面的操作
     * <chapter version="5.0">替换成<chapter xmlns="http://docbook.org/ns/docbook" version="5.0" xml:lang="zh_cn">
