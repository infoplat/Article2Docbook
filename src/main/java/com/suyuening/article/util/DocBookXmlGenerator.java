...
public final class DocBookXmlGenerator {
    ...
    public static void main(String[] args) {
        ...
        List<String> paras = Lists.newArrayList("我一直不太理解父亲。",
        ...
        List<DocBookChapter> chapters = Lists.newArrayList(new DocBookChapter("散文卷一", sections),
                                                           new DocBookChapter("散文卷二", sections));
